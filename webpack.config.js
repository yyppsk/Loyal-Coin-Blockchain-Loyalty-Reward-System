...
module.exports = {
  ...
  devServer: {
    static: [
      {
        ...
        publicPath: "/", // Use / as the publicPath for your bundled files
      },
      {
        directory: path.join(__dirname, "public"),
        publicPath: "/public/", // Use /public/ as the publicPath for your static assets
        watch: true,
      },
    ],
    compress: true,
    ...
    proxy: {
      "/": "http://localhost:3001",
      "/assets": "http://localhost:3001", // Proxy requests for /assets to your other server
    },
  },
  module: {
    rules: [
